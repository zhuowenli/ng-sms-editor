...
var BlockEmbed = _quill2.default.import('blots/embed');

var MarkBlot = function (_BlockEmbed) {
    _inherits(MarkBlot, _BlockEmbed);

    function MarkBlot() {
        _classCallCheck(this, MarkBlot);

        return _possibleConstructorReturn(this, (MarkBlot.__proto__ || Object.getPrototypeOf(MarkBlot)).apply(this, arguments));
    }
    ...
    _createClass(MarkBlot, null, [{
        ...
        value: function create(_ref) {
            ...
            var node = _get(MarkBlot.__proto__ || Object.getPrototypeOf(MarkBlot), 'create', this).call(this);
...
exports.default = function () {
    return {
        ...
        link: function link($scope, element, attr, ngModel) {
            ...
            var quill = new _quill2.default(element[0], options);
            ...
            ngModel.$render = function () {
                ...
                if (value) {
                    ...
                    value.replace(/#[^a-z0-9A-Z]+?#/g, function (text) {
                        return '@@@' + text + '@@@';
                        ...
                        if (/#[^a-z0-9A-Z]+#/.test(text)) {
                            ...
                            quill.insertEmbed(length - 1, 'mark', { value: text, id: id }, _quill2.default.sources.USER);
            ...
            $scope.$watch('insertText', function () {
                ...
                if (value) {
                    ...
                    quill.insertEmbed(range.index, 'mark', { value: value, id: id }, _quill2.default.sources.USER);
                    ...
                    quill.setSelection(range.index + 2, _quill2.default.sources.SILENT);
            ...
            quill.on('text-change', function () {
                ...
                ops.map(function (item) {
                    if (item.insert) {
                        text += _typeof(item.insert) === 'object' ? item.insert.mark : item.insert.trim();
                    }
                    return item;
                });
            ...
            quill.clipboard.addMatcher(Node.ELEMENT_NODE, function (node) {
                return new _quillDelta2.default().insert(node.innerText.trim().replace(emoji, ''));
            });
            quill.clipboard.addMatcher(Node.TEXT_NODE, function (node) {
                return new _quillDelta2.default().insert(node.data.trim().replace(emoji, ''));
            });
        }
    };
};
...
var ngSmsEditor = function () {
    function ngSmsEditor($scope, $element, $sce) {
        ...
        $scope.$watch('ctrl.labels', function (newValue) {
            if (newValue.length) {
                _this.placeholderMap = _this.genPlaceholderMap(_this.labels);
            }
        }, true);
        $scope.$watch('ctrl.content', function () {
            return _this.countContentLen();
        });
    }
    ...
    _createClass(ngSmsEditor, [{
        ...
        value: function countContentLen() {
            var contentParsered = void 0;
            var contentLength = void 0;
            var realContent = void 0;
...
exports.default = _module3.default.directive('smsEditor', _editor2.default).component('ngSmsEditor', {
    template: template,
